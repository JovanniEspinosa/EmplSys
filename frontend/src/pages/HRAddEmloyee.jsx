...
const HRAddEmployee = () => {
  ...
  const handleAddEmployee = async (e) => {
    ...
    setConfirmationModal({
      ...
      message: `Are you sure you want to create a new employee account with username "${username}"? They will be able to access the system with the provided credentials.`,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#260058] to-[#3e0091] px-8 py-12">
            ...
            <p className="mt-2 text-purple-100">Create a new employee account with department assignment</p>
          </div>
              ...
              <div className={`p-4 rounded-xl shadow-lg border ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-medium">
                    {status ? "Employee account created successfully!" : "Failed to create employee account"}
                  </p>
                </div>
              </div>
            </div>
